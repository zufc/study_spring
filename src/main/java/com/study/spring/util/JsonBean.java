...
public class JsonBean implements Serializable {
     ...
     * @since [产品/模块版本](可选)
     */
    public static JsonBean convertFromMap(Map<String, Object> map) {
        if (map == null) {
            return null;
        }
        JsonBean result = new JsonBean();
        result.setResult((Boolean) map.get("result"));
        result.setMessage((String) map.get("message"));
        result.setData(map.get("data"));
        result.setVoiceMsg((String) map.get("voiceMsg"));
        return result;
    }
